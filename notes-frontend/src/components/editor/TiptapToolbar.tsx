  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <input type="color" aria-label="文字颜色" title="文字颜色" onChange={(e) => exec('color', { color: e.target.value })} style={{ width: 28, height: 28, border: '1px solid var(--border)', borderRadius: 6, background: 'var(--surface-1)' }} />
        {/* 撤销/重做/保存 */}
